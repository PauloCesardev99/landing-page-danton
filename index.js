...
ACORDION.map((e, i)=>{
    ...
    e.addEventListener("click", ()=>{
        ...
        if (i===0){
            ...
            duvidas_ocultadas[5].classList.toggle("duvida-ocultada-toggle")
        } else if (i===6){
            duvidas_ocultadas[6].classList.toggle("duvida-ocultada-toggle")
        } else if (i===7){
            duvidas_ocultadas[7].classList.toggle("duvida-ocultada-toggle")
        } else{
            duvidas_ocultadas[8].classList.toggle("duvida-ocultada-toggle")
        }
